...
from objects.api_client import APIClient
...
def pytest_addoption(parser):
    ...
    parser.addoption("--log-dir", action="store", help="Logging Directory")
...
@pytest.fixture(scope="session")
def openmeteo(request):
    config = get_config(request)
    base_url = config["base_url"]
    openmeteo_api = APIClient(base_url)
